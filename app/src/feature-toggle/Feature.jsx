 ...
 * @property {Object}  props.loadConfigurationFrom - A function returning a configuration object: { [featureName]: { enabled: boolean } }
 * 
...
export const FeatureToggleProvider = (props) => {
    const { loadConfigurationFrom, canOverrideFeatures, includeAdminPanel, children } = props;
    featureSettings = loadConfigurationFrom();
...
function FeatureToggleContextProvider(props) {
